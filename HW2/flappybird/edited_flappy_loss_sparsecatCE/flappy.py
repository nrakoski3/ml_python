...
def main():
    ...
    # game over sprite
    IMAGES['gameover'] = pygame.image.load_basic(os.path.join('assets/sprites/', 'gameover.png')).convert_alpha()
    # message sprite for welcome screen
    IMAGES['message'] = pygame.image.load_basic(os.path.join('assets/sprites/', 'message.png')).convert_alpha()
    # base (ground) sprite
    IMAGES['base'] = pygame.image.load_basic(os.path.join('assets/sprites/', 'base.png')).convert_alpha()
